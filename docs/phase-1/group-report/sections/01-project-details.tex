...
\begin{itemize}
  ...
  \item \textbf{Hệ thống bên ngoài cung cấp:} \texttt{EXT-STATE} gửi trạng thái cảm biến hoặc dữ liệu giả lập về xe, mức pin, chỗ đỗ, cổng sạc và sự kiện vận hành. Cách thiết bị tạo hoặc truyền dữ liệu nằm ngoài phạm vi.
\end{itemize}
...
Đơn vị quản lý Khu đô thị ĐHQG-HCM là stakeholder nhưng chưa phải actor trong phạm vi hiện tại vì chưa có use case trao đổi trực tiếp với hệ thống. Các thiết bị vật lý cũng không được xem là actor độc lập; toàn bộ dữ liệu thiết bị đi qua hệ thống bên ngoài \texttt{EXT-STATE}. Trong mô hình use case, hệ thống bên ngoài này tham gia dưới vai trò \texttt{ACT-DAT}. Cách xác định này tránh đưa database, service nội bộ hoặc đối tượng dữ liệu lên use-case diagram như những tác nhân của hệ thống.
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.78\textwidth]{../diagrams/plantuml/output/subsystem-map.pdf}
  \caption{Bản đồ bảy phân hệ và các phụ thuộc nghiệp vụ chính}
